...
async function makeStoreofficer(formData: FormData) {
  'use server'
  await setRole(formData)
}
                  ...
                  <tr key={user.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <form action={makeStoreofficer}>
                          <input type="hidden" name="id" value={user.id} />
                          <input type="hidden" name="role" value="store_officer" />
                          <button 
                            type="submit" 
                            className="bg-purple-400 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm transition-colors"
                          >
                            Store Officer
                          </button>
                        </form>
