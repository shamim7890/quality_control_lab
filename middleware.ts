...
export default clerkMiddleware(async (auth, req) => {
    ...
    if (userId) {
        ...
        // Store Officer has access to all routes except admin panel
        ...
        // Approver roles (Technical Managers, Directors, QA Managers)
        ...
        // Default: block access to protected routes for unknown roles
        if (isAdminRoute(req) || isApproverRoute(req) || 
